...
func _ready():
    ...
    var ginkgo_tex = preload("res://assets/ui/selected_character_hud.png")
    var raul_tex = preload("res://assets/ui/selected_character_black_hud.png")
    var steve_tex = preload("res://assets/characters/steve/steve_hud.png")
    var isabel_tex = preload("res://assets/characters/isabel/splash.png")
    ...
    elif GameManager.selected_cat == "isabel":
        cat_portrait.texture = isabel_tex
    else:
